...
-- CreateEnum
CREATE TYPE "Conditions" AS ENUM ('FRESH', 'OLD');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('BKASH', 'NAGAD', 'CASH_ON_DELIVERY', 'SSL_COMMERZ');
...
CREATE TABLE "products" (
    ...
    "condition" "Conditions" NOT NULL DEFAULT 'FRESH',
